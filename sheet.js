...
function displaySheet(sheetData) {
    ...
    sheetData.forEach(row => {
        ...
        Object.values(row).forEach(value => {
            ...
            td.innerText = value !== null ? value : ''; // Show empty string for null
            tableRow.appendChild(td);
        });
        table.appendChild(tableRow);
    });

    sheetContentDiv.appendChild(table); // Append the table to the content div
}

// Function to apply filtering operations based on user input
